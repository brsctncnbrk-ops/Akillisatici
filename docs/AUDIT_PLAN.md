...
> Oluşturulma: 2026-06-16 · Durum: **Faz 1-4 tamamlandı ✓ · Faz 5 bekliyor** (ESP kararı kullanıcıda)
...
>
> **Kullanıcı kararı (ESP — `docs/ESP_PLAN.md` §5):** ESP seçimi (Brevo öneri), gönderen alan adı,
> entegrasyon tercihi (A: Brevo formu / B: serverless route). Karar verilince kod entegrasyonu +
> welcome serisi ayrı adımda. Lead magnet altyapısı ESP'den bağımsız çalışır.
